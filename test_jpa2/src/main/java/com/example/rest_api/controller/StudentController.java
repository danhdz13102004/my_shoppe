...
public class StudentController {
    ...
    public List<Student> findByNotFirstName(@PathVariable String name) {
            return studentService.getAllStudentNotFirstName(name);
    }
    @GetMapping("/not-contain-first-name/{name}")
    public List<Student> findByFirstNameNotContaining(@PathVariable String name) {
            return studentService.findByFirstNameNotContaining(name);
    }
    @PostMapping
